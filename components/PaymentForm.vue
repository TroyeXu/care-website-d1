  ...
  <q-card flat bordered>
    <q-card-section>
      ...
      <q-form @submit.prevent="submit" class="q-gutter-md">
        ...
        <!-- 信用卡資訊 -->
        <div v-if="method === 'credit_card'" class="q-pa-md bg-grey-1 rounded-borders">
          ...
          <div class="row q-gutter-md">
            ...
            <div class="col-6">
              <q-select
                ...
                :options="Array.from({length: 12}, (_, i) => ({label: String(i + 1).padStart(2, '0'), value: String(i + 1).padStart(2, '0')}))"
                label="月份 *"
                outlined
                dense
                emit-value
            ...
            <div class="col-6">
              <q-select
                ...
                :options="Array.from({length: 10}, (_, i) => ({label: String(2024 + i), value: String(2024 + i)}))"
                label="年份 *"
                outlined
                dense
                emit-value
        ...
        <!-- 銀行轉帳說明 -->
        <div v-else-if="method === 'bank_transfer'" class="q-pa-md bg-blue-1 rounded-borders">
          <div class="text-subtitle2 q-mb-sm">銀行轉帳資訊</div>
          <div class="text-body2">
            <div>銀行：台灣銀行</div>
            <div>戶名：護理服務平台有限公司</div>
            <div>帳號：123-456-789012</div>
            <div class="text-caption text-grey-6 q-mt-sm">請於轉帳完成後提交此表單</div>
          </div>
        </div>
        
        <!-- 現金付款說明 -->
        <div v-else-if="method === 'cash'" class="q-pa-md bg-green-1 rounded-borders">
