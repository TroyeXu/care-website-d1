...
VALUES 
  ('da830281-bafb-4c3b-9f62-bd417c05af02', '超級管理員', '擁有所有權限', '["*"]', datetime('now'), datetime('now')),
  ('c1043456-f338-444c-aad1-b0da754d5773', '管理員', '一般管理權限', '["users.read","users.update","booking.read","booking.update","provider.read","provider.update"]', datetime('now'), datetime('now')),
  ('481907f2-69bb-4531-997c-8c735158e4bc', '客服人員', '客服權限', '["booking.read","booking.update","users.read"]', datetime('now'), datetime('now'));
...
一般管理員：manager@example.com / admin123
客服人員：operator@example.com / admin123
