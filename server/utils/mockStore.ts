...
const caregivers: ServerCaregiver[] = [
  {
    id: 'caregiver-1',
    user_id: 'user-2',
    name: '張美麗',
...
const reviews: Review[] = [
  ...
  },
  {
    ...
    rating: 5,
    comment:
      '張美麗護理師非常專業，對待我的父親就像家人一樣。她的失智症照護經驗豐富，讓我們很放心。',
  ...
  },
  {
    ...
    rating: 4,
    comment:
      '林志明護理師的重症護理經驗確實很豐富，處理緊急狀況很冷靜。只是希望能更準時一些。',
  ...
  },
  {
    ...
    rating: 5,
    comment:
      '王淑芬護理師的復健指導非常專業，我的膝蓋恢復得很好。她很有耐心，會仔細說明每個動作。',
  ...
  },
  {
    ...
    rating: 5,
    comment:
      '陳美玲護理師照顧我的母親已經半年了，她的專業和愛心讓全家人都很感動。強烈推薦！',
...
export const mockStore = {
  ...
  caregivers: {
    ...
    getByUserId: (userId: string) =>
      caregivers.find((c) => c.user_id === userId),
  ...
  bookings: {
    ...
    getByPatientId: (patientId: string) =>
      bookings.filter((b) => b.user_id === patientId),
    getByCaregiverId: (caregiverId: number) =>
      bookings.filter((b) => b.caregiver_id === caregiverId),
  ...
  reviews: {
    ...
    getByCaregiverId: (caregiverId: number) =>
      reviews.filter((r) => r.caregiver_id === caregiverId),
